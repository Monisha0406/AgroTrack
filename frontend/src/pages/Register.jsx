...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-agLight px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-white p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full max-w-md border border-gray-100 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8 mt-2">
          ...
          <p className="text-sm text-gray-500 mt-1">Join the AgriTrack fleet network</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="appearance-none block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-agGreen-500 focus:border-agGreen-500 sm:text-sm bg-gray-50 focus:bg-white text-gray-900 font-medium" 
          ...
          <div>
            ...
            <select
              ...
              className="appearance-none block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-agGreen-500 focus:border-agGreen-500 sm:text-sm bg-gray-50 focus:bg-white text-gray-900 font-medium cursor-pointer"
            >
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          Already have an account? <Link to="/login" className="font-semibold text-agGreen-600 hover:text-agGreen-500 transition-colors">Sign in</Link>
        </div>
      </div>
    </div>
  );
